/* @ts-self-types="./wordle_stuff.d.ts" */

/**
 * @returns {number}
 */
export function black_tile() {
    const ret = wasm.black_tile();
    return ret;
}
 ...
 * @returns {any}
 */
export function generate_trials(answer, n_trials, seed, hard_mode) {
    const ptr0 = passStringToWasm0(answer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.generate_trials(ptr0, len0, n_trials, seed, hard_mode);
    if (ret[2]) {
 ...
 * @returns {number}
 */
export function green_tile() {
    const ret = wasm.green_tile();
    return ret;
}
 ...
 * @returns {any}
 */
export function hard_mode_match_exists(observations) {
    const ret = wasm.hard_mode_match_exists(observations);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function hard_mode_match_exists_with_candidates(observations, candidates) {
    const ret = wasm.hard_mode_match_exists_with_candidates(observations, candidates);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function hard_mode_match_exists_with_progress(observations, progress_callback) {
    const ret = wasm.hard_mode_match_exists_with_progress(observations, progress_callback);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function match_exists(observations) {
    const ret = wasm.match_exists(observations);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function parse_match(match_text) {
    const ptr0 = passStringToWasm0(match_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_match(ptr0, len0);
    if (ret[3]) {
 ...
 * @returns {string}
 */
export function score_word(guess, solution) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.score_word(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {number}
 */
export function yellow_tile() {
    const ret = wasm.yellow_tile();
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wordle_stuff_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
